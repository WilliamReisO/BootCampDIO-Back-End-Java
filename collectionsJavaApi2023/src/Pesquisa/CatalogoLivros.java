...
public static void main(String[] args) {
	...
	catalogoLivros.adicionarLivro("Livro 2","Autor 1", 2020);
	catalogoLivros.adicionarLivro("Livro 3","Autor 2", 2021);
	catalogoLivros.adicionarLivro("Livro 4","Autor 2", 2017);
	catalogoLivros.adicionarLivro("Livro 5","Autor 3", 2022);
	catalogoLivros.adicionarLivro("Livro 6","Autor 4", 2023);
